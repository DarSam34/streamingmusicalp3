<div class="container-fluid fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary rounded-pill px-4 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalNuevaPlaylist">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4><i class="fas fa-globe-americas me-2 text-success"></i> <span data-key="pl_explorar">Explorar Playlists Públicas</span></h4>
    ...
    <div class="row" id="lista-playlists-publicas">
        <div class="col-12 text-center py-3">
            <span class="text-muted"><i class="fas fa-search me-1"></i> Escribe para buscar playlists públicas de otros usuarios.</span>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="fas fa-plus-circle me-2"></i> <span data-key="pl_nueva">Nueva Playlist</span></h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body p-4">
                <div class="mb-3">
                    <label class="form-label fw-bold text-muted" data-key="pl_nombre">Nombre de la lista</label>
                    <input type="text" id="playlist-nombre" class="form-control form-control-lg bg-light border-0" placeholder="Ej. Rock Clásico" maxlength="100">
                </div>
                <div class="mb-3">
                    ...
                    <select id="playlist-visibilidad" class="form-select form-select-lg bg-light border-0">
                        ...
                        <option value="Colaborativa" data-key="pl_colaborativa">Colaborativa (Pública y otros pueden añadir)</option>
                    </select>
                </div>
            </div>
            <div class="modal-footer border-0">
                <button type="button" class="btn btn-light px-4" data-bs-dismiss="modal" data-key="pl_cancelar">Cancelar</button>
...
<style>
    .playlist-card { transition: transform 0.2s, box-shadow 0.2s; border-radius: 12px; }
    .playlist-card:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.1) !important; }
</style>
